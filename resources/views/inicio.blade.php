...
<section class="bg-white dark:bg-gray-900">
  <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-6">
      <div class="mx-auto max-w-screen-sm">
          ...
          <p class="mb-8 font-light text-gray-500 lg:mb-16 sm:text-xl dark:text-gray-400">Conheça um dos melhores cursos de ensino superior da cidade de tatui, nele você terá conhecimento da área de gestão</p>
      </div>
      <div class="grid mb-8 lg:mb-12 lg:grid-cols-2">
          <figure class="flex flex-col justify-center items-center p-8 text-center bg-gray-50 border-b border-gray-200 md:p-12 lg:border-r dark:bg-gray-800 dark:border-gray-700">
              <blockquote class="mx-auto mb-8 max-w-2xl text-gray-500 dark:text-gray-400">
                  <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Tenha aulas com professores, mestres e especialisas.</h3>
                  <p class="my-4">"No curso de GTI tive oportunidades  de conhecer diveros professores com sólidos conhecimentos na área, me ajudando a direcionar minha carreira.</p>
                  <p class="my-4">O curso foi o ponto de virada na minha vida e na minha carreira.</p>
